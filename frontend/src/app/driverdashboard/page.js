    ...
    <div className="p-8 bg-gray-900 text-white min-h-screen">
          ...
          <div className="text-sm">
            {isCheckingRegistration ? (
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-green-500">Registered Driver</span>
              </div>
            ) : (
              <div className="flex flex-col">
                <span className="text-gray-400">Status</span>
      ...
      {step === 2 && (
        <div className="bg-gray-800 rounded-lg p-6 shadow-lg mt-8">
          <h2 className="text-3xl font-bold mb-4">Complete Verification To Access Your Driver Portal</h2>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              {isRegistered ? "Already Registered" : isCheckingRegistration ? "Checking..." : "Start Now"}
            </button>
          </div>
        </div>
      )}
