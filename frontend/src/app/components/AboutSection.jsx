      ...
      <div className="relative container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center md:space-x-5 z-10">
        ...
        <div className="w-full md:w-2/3 text-center md:text-left">
          ...
          <motion.p
            ...
            transparency, and flexibility to how you move. Built on the Internet Computer blockchain,
          ...
          <motion.p
            ...
            With ChainMove, you can book a ride, rent a car for a few hours or days, or even share trips with
            friends for more convenient and eco-friendly travel.
          </motion.p>
        </div>
      </div>
    </section>
