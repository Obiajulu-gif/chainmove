  ...
  return (
    <section className="w-full bg-gradient-to-br from-gray-900 to-gray-800 py-16 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(to bottom right,#1F2937, #111827), url(/images/bg.png)",
      ...
      <div className="relative container mx-auto text-center z-10">
        ...
        <motion.div
          ...
          <h2 className="text-white text-3xl md:text-4xl font-semibold mt-4">User Shared Insight</h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            <p className="text-gray-300 mb-6">
              ChainMove is incredibly reliable. I can top up my phone, pay bills, and save money effortlessly.
            </p>
            <div className="flex items-center space-x-4">
              <Image src="/images/av1.png" alt="User 1" width={50} height={50} className="rounded-full" />
          ...
          <motion.div
            ...
            <div className="flex items-center space-x-4">
              <Image src="/images/av1.png" alt="User 2" width={50} height={50} className="rounded-full" />
              <div className="text-left">
          ...
          <motion.div
            ...
            <div className="flex items-center space-x-4">
              <Image src="/images/av1.png" alt="User 3" width={50} height={50} className="rounded-full" />
              <div className="text-left">
