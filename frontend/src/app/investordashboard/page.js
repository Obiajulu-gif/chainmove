...
import { FaCamera, FaClock, FaDollarSign, FaIdCard, FaUser } from "react-icons/fa";
  ...
  return (
    <div className="p-8 bg-gray-900 text-white min-h-screen">
      ...
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-semibold">Onboarding &gt;&gt; Investor Verification</h1>{" "}
        ...
        <div className="bg-gray-800 rounded-lg p-6 flex items-center justify-between shadow-lg">
          ...
          <div className="w-1/2 pl-8">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              As a ChainMove Investor, you have the freedom to earn from every Funding and investment while
              taking full advantage of our blockchain-powered platform.
            </p>
